      ...
      <div className="aui-thread-welcome-center flex w-full grow flex-col items-center justify-center">
        <div className="aui-thread-welcome-message flex size-full flex-col justify-center px-4">
          <h1 className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-2xl font-semibold duration-200">
            Ask FootQuery anything
          </h1>
          <p className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-muted-foreground text-xl delay-75 duration-200">
            Premier League 2024/25 stats in plain English.
          </p>
        </div>
      </div>
      <ThreadSuggestions />
...
const ThreadSuggestions: FC = () => {
  return (
    <div className="aui-thread-welcome-suggestions grid w-full gap-2 pb-4 @md:grid-cols-2">
      {FOOTQUERY_SUGGESTIONS.map((suggestion) => (
        <div
          key={suggestion}
        ...
        >
          <ThreadPrimitive.Suggestion prompt={suggestion} send asChild>
            <Button
              variant="ghost"
              className="aui-thread-welcome-suggestion bg-background hover:bg-muted h-auto w-full flex-wrap items-start justify-start gap-1 rounded-3xl border px-4 py-3 text-start text-sm transition-colors"
            >
              {suggestion}
            </Button>
            ...
            switch (part.type) {
              ...
              case "indicator":
                return (
                  ...
                  >
                    <SoccerBallSpinner className="size-5" />
                    <span className="shimmer text-sm font-medium motion-reduce:animate-none">
                      Thinking
                    </span>
                  </span>
                );
